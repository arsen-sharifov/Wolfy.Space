    ...
    <div className="bg-bg-color flex min-h-screen justify-center p-6">
      <div className="w-[85vw]">
          ...
          <div className="mb-4 flex items-center">
            ...
            <div>
              <h2 className="text-2xl font-bold">
                Jafry Goodman
                <span className="text-text-color rounded bg-pink-500 px-2 py-1 text-sm">admin</span>
              </h2>
              <p className="mt-1">
        ...
        <div className="flex flex-col items-center space-y-6">
          <div className="bg-primary-color w-full max-w-2xl rounded-lg p-6 shadow-lg">
